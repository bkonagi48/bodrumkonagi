...
(function () {
  ...
  function initRoomBookingForms() {
    ...
    $$(".room-booking").forEach(function (form) {
      ...
      var nightsInput = form.querySelector(".room-booking__nights");
      if (nightsInput) {
        convertToCustomSelect(nightsInput);
      }

      var guestsInput = form.querySelector(".room-booking__guests");
      if (guestsInput) {
        convertToCustomSelect(guestsInput);
      }
  ...
  function convertToCustomSelect(selectEl) {
    ...
    dropdown.className = "custom-select-dropdown glass";
  ...
  function convertToCustomDatePicker(dateInputEl) {
    ...
    calendar.className = "custom-datepicker-calendar glass";
