...
(function () {
  ...
  function initLeafletMap() {
    ...
    function startMap() {
      ...
      if (!leaflet) return;
      var lat = 37.036556, lng = 27.431348;
  ...
  function init() {
    ...
    initCursor(); initHeader(); initMenu(); initTabs(); initBooking(); initRoomSliders(); initCounters(); initParallax(); initSecNav(); initLeafletMap();
